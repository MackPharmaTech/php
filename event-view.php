                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"><?php echo $this->lang->line('event_audit');?></div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active"><?php echo $this->lang->line('event_audit');?></li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><?php echo $this->lang->line('event_audit');?></header>
                                </div>
                         ...
                         <div class="alert alert-danger " role="alert">
                          ...
                          <?php } ?>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                        <button type="submit" class="btn btn-round btn-info" name="btn-submit"><?php echo $this->lang->line('GEN_REP');?></button>
                                        </div>
                            </div>
                                    </form>
                                <?php } ?>
